...
exports.wireInModels = function (app) {
    app.use(orm.express(conf.mysqlConnectionString(), {
        define: function (db, models) {
            ...
            models.assignment.hasOne("task", models.task, {autoFetch: true});

            models.userlink.hasOne("user", models.appUser, { required: true, autoFetch: true });
